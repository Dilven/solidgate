...
const items = [
  ...
  { 
    ...
    description: "Szeroki wybór bram i furtek. Posiadamy w ofercie bramy 2-skrzydłowe jak i przesuwne w wielu wzorach.",
    img: galeriaBalustradyImg,
    href: galleryPaths.balustradySchodowe
  },
  { 
    title: "Furtki i bramy",
    description: "Aby sprostać oczekiwaniom współczesnych klientów, posiadamy spory wybór wzorów balustrad schodowych",
    img: galeriaBalustradyImg,
    href: galleryPaths.bramyIFurtki
  },
  { 
    title: "Ogrodzenia",
    description: "Dobrze wybrane ogrodzenie wraz z bramą i furtką tworzą piękną wizytówke naszego domu.",
    img: galeriaBalustradyImg,
